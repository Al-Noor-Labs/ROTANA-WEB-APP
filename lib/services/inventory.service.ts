...
export async function applyInventoryEvent(
    ...
    logger.debug(
        { variantId: input.variantId, locationId: input.locationId, eventType: input.eventType, quantity: input.quantity },
...
function resolveBalanceDelta(
    ...
    switch (eventType) {
        ...
        default: {
            ...
            logger.warn({ eventType: _exhaustive }, "Unknown InventoryEventType — no balance delta applied");
