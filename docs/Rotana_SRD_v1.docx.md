...
_Software Requirements Document (SRD)_
...
_This document defines the functional scope, module breakdown, user roles, and technical approach agreed upon in the discovery session. It serves as the baseline for project estimation, timeline planning, and future change requests._
...
_Document prepared by Alnoor Labs — Confidential & Proprietary_
