...
async function main() {
  ...
  const catRes = await post(
    '/categories',
    { name: `General Goods ${ts}`, description: 'Diverse testing category' },
    token,
  );
  ...
  const sampleProducts = [
    ...
    },
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1590483734724-38fa19dd4438?auto=format&fit=crop&w=800',
    ...
    },
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?auto=format&fit=crop&w=800',
    ...
    },
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1583947215259-38e31be8751f?auto=format&fit=crop&w=800',
  ...
  // 4. Verify Dashboard
  setTimeout(async () => {
    const dash = await fetch(`${BASE_URL}/dashboard`, {
